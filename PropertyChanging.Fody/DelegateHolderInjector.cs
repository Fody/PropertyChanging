...
public partial class ModuleWeaver
{
    ...
    public void InjectDelegateHolder(TypeDefinition targetTypeDefinition, MethodReference onPropertyChangingMethodReference)
    {
    ...
    {
        MethodDefinition = new MethodDefinition("OnPropertyChanging", MethodAttributes.Public | MethodAttributes.HideBySig, ModuleDefinition.TypeSystem.Void);
